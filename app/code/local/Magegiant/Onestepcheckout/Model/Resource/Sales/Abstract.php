 ...
 */
abstract class Magegiant_Onestepcheckout_Model_Resource_Sales_Abstract extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
     ...
     *
     * @param Mage_Customer_Model_Attribute $attribute
     * @return Magegiant_Onestepcheckout_Model_Resource_Sales_Abstract
     */
     ...
     *
     * @param Magegiant_Onestepcheckout_Model_Sales_Abstract $sales
     * @return bool
     */
    public function isEntityExists(Magegiant_Onestepcheckout_Model_Sales_Abstract $sales)
    {
        if (!$sales->getId()) {
            return false;
        }
