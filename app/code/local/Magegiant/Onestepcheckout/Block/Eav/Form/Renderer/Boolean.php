 ...
 */
class Magegiant_Onestepcheckout_Block_Eav_Form_Renderer_Boolean extends Magegiant_Onestepcheckout_Block_Eav_Form_Renderer_Select
{
    /**
    ...
    public function getOptions()
    {
        return array(
            ...
            array(
                'value' => '0',
                'label' => Mage::helper('onestepcheckout')->__('No')
            ),
            array(
                'value' => '1',
                'label' => Mage::helper('onestepcheckout')->__('Yes')
            ),
        );
    }
}
