 ...
 */
class Magegiant_Onestepcheckout_Block_Adminhtml_Customer_Formtype_Edit_Tab_Tree
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    public function getTreeButtonsHtml()
    {
        $addButtonData = array(
            'id'        => 'add_node_button',
            'label'     => Mage::helper('onestepcheckout')->__('New Fieldset'),
    ...
    public function getFieldsetButtonsHtml()
    {
        ...
        $buttons[] = $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
            'id'        => 'save_node_button',
            'label'     => Mage::helper('onestepcheckout')->__('Save'),
            'onclick'   => 'formType.saveFieldset()',
            'class'     => 'save',
        ))->toHtml();
        $buttons[] = $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
            'id'        => 'delete_node_button',
            'label'     => Mage::helper('onestepcheckout')->__('Remove'),
            'onclick'   => 'formType.deleteFieldset()',
            'class'     => 'delete',
        ))->toHtml();
        $buttons[] = $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
            'id'        => 'cancel_node_button',
            'label'     => Mage::helper('onestepcheckout')->__('Cancel'),
    ...
    {
        return Mage::helper('onestepcheckout')->__('Attributes');
    }
